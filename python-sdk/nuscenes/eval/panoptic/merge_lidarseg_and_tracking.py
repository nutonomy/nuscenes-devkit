...
Example usage:
python python-sdk/nuscenes/panoptic/merge_seg_and_track.py --seg_path ./nuscenes-lidarseg \
 --track-path ./track.json --eval_set val verbose True --dataroot /data/sets/nuscenes
"""
import argparse
import os
