...
- **AMOTA** (average multi object tracking accuracy): Average over the MOTA metric defined below. Note that the original definition did not include the term `(1-r) * TP_r` which gives values in `[0, 1]`.
