...
<a href="https://www.codecogs.com/eqnedit.php?latex=\dpi{200}&space;\mathit{AMOTA}&space;=&space;\small&space;\frac{1}{n-1}&space;\sum_{r&space;\in&space;\{\frac{1}{n-1},&space;\frac{2}{n-1},&space;..,&space;1\}}&space;1&space;-&space;\frac{\mathit{IDS}_r&space;&plus;&space;\mathit{FP}_r&space;&plus;&space;\mathit{FN}_r&space;-&space;(1&space;-&space;r)&space;*&space;\mathit{TP}_r}{r&space;*&space;\mathit{TP}_r}" target="_blank"><img src="https://latex.codecogs.com/png.latex?\dpi{80}&space;\mathit{AMOTA}&space;=&space;\small&space;\frac{1}{n-1}&space;\sum_{r&space;\in&space;\{\frac{1}{n-1},&space;\frac{2}{n-1},&space;..,&space;1\}}&space;1&space;-&space;\frac{\mathit{IDS}_r&space;&plus;&space;\mathit{FP}_r&space;&plus;&space;\mathit{FN}_r&space;-&space;(1&space;-&space;r)&space;*&space;\mathit{TP}_r}{r&space;*&space;\mathit{TP}_r}" title="\mathit{AMOTA} = \small \frac{1}{n-1} \sum_{r \in \{\frac{1}{n-1}, \frac{2}{n-1}, .., 1\}} 1 - \frac{\mathit{IDS}_r + \mathit{FP}_r + \mathit{FN}_r - (1 - r) * \mathit{TP}_r}{r * \mathit{TP}_r}" /></a>
