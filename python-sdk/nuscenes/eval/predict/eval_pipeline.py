...
if __name__ == "__main__":
    ...
    do_inference.main(args.version, args.split_name, args.output_dir, args.submission_name, args.config_name)
    compute_metrics.main(args.version, args.output_dir, args.submission_name, args.config_name)