...
class NuScenesExplorer:
    ...
    def render_sample_data(self,
        ...
        :param show_lidarseg_labels: When set to True, the LIDAR segmentation labels are plotted. When False, the
            colors of the points represents the distance from the ego vehicle's center
        """
